...
#import "TTProgressPopUpView.h"
#import "TTPopUpView.h"
@interface TTProgressPopUpView() <ASPopUpViewDelegate>
@property (strong, nonatomic) NSNumberFormatter *numberFormatter;
@property (strong, nonatomic) ASPopUpView *popUpView;
@end

@implementation TTProgressPopUpView
{
...
- (void)setDataSource:(id<TTProgressPopUpViewDataSource>)dataSource
{
